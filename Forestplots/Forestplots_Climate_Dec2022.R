###-----------------------------------------------------------------------------------------###
### TITLE:       FORESTPLOTS CLIMATE SCENARIOS                                              ###
...
###              the distinct scenarios for each region and exports results as forestplot   ### 
###              images + csv datasets                                                      ###
### DATE:        20.12.2022                                                                 ###
###-----------------------------------------------------------------------------------------###        
...
#SSP2.6_2100
cohorts_SSP2.6_2100_control <- SSP2.6_2100_list[[1]]$time_line_cohorts %>% filter(Month > 2280) %>% rowwise() %>% 
  dplyr::mutate(BiomassSum = sum(c(Biomass_FG_0,Biomass_FG_1,Biomass_FG_2,Biomass_FG_3,Biomass_FG_4,Biomass_FG_5,Biomass_FG_6,Biomass_FG_7,Biomass_FG_8)),
  ...
  summarize(Month,Year,Biomass_FG_0,Biomass_FG_1,Biomass_FG_2,Biomass_FG_3,Biomass_FG_4,Biomass_FG_5,BiomassSum,Scenario,Group) %>%
   ungroup() %>%   as.data.frame()
#SSP8.5_2100
cohorts_SSP8.5_2100_control <- SSP8.5_2100_list[[1]]$time_line_cohorts %>% filter(Month > 2280) %>% rowwise() %>% 
  dplyr::mutate(BiomassSum = sum(c(Biomass_FG_0,Biomass_FG_1,Biomass_FG_2,Biomass_FG_3,Biomass_FG_4,Biomass_FG_5,Biomass_FG_6,Biomass_FG_7,Biomass_FG_8)),
...
effect_hist_SSP126 <- data.frame(c("Europe"),
...
#create a effect size data frame = base for forest plot
effect_hist_SSP585 <- data.frame(c("Europe"),
                                 c("End. Herbivores","End. Carnivores","End. Omnivores",
                                   "Ect. Herbivores","Ect. Carnivores","Ect. Omnivores","Overall Biomass"),
                                 c(1,2,3,4,5,6,7),
                                 c(FG1$t0[1],FG2$t0[1],FG3$t0[1],FG4$t0[1],FG5$t0[1],FG6$t0[1],Overall$t0[1]),
...
#create factor lvls 
effect_hist_SSP126$`Functional Group`<- factor(effect_hist_SSP126$`Functional Group`,levels=c("Overall Biomass","End. Herbivores","End. Carnivores","End. Omnivores","Ect. Herbivores","Ect. Carnivores","Ect. Omnivores"))
effect_hist_SSP585$`Functional Group`<- factor(effect_hist_SSP585$`Functional Group`,levels=c("Overall Biomass","End. Herbivores","End. Carnivores","End. Omnivores","Ect. Herbivores","Ect. Carnivores","Ect. Omnivores"))

#add overall biomass line
effect_hist_SSP126$GrandMean <- ifelse(grepl("End.",effect_hist_SSP126$`Functional Group`)|grepl("Ect.",effect_hist_SSP126$`Functional Group`),FALSE,TRUE)
effect_hist_SSP585$GrandMean <- ifelse(grepl("End.",effect_hist_SSP585$`Functional Group`)|grepl("Ect.",effect_hist_SSP585$`Functional Group`),FALSE,TRUE)

#now plot the forest plot 
Europe <- ggplot() +
  geom_point(data=effect_hist_SSP126,aes(x=Eff_size,y=`Functional Group`,col="Historical/SSP1-2.6",size=ifelse(grepl("res",`Functional Group`),Biomass,3000),shape=GrandMean))+
  geom_errorbar(data=effect_hist_SSP126,aes(xmin=lower,xmax=upper,y=`Functional Group`,col="Historical/SSP1-2.6"),width=0.1,size=0.3)+
  geom_point(data=effect_hist_SSP585,aes(x=Eff_size,y=`Functional Group`,col="Historical/SSP5-8.5",size=ifelse(grepl("res",`Functional Group`),Biomass,3000),shape=GrandMean))+
  geom_errorbar(data=effect_hist_SSP585,aes(xmin=lower,xmax=upper,y=`Functional Group`,col="Historical/SSP5-8.5"),width=0.1,size=0.3)+
  scale_color_brewer(palette = "Set1",direction=-1)+
  scale_size_continuous(guide="none")+
  scale_x_continuous(breaks = seq(-100,100,5),limits=c(-15,5))+
...
#create a effect size data frame = base for forest plot
effect_hist_SSP126 <- data.frame(c("India"),
                                 c("End. Herbivores","End. Carnivores","End. Omnivores",
                                   "Ect. Herbivores","Ect. Carnivores","Ect. Omnivores","Overall Biomass"),
                                 c(1,2,3,4,5,6,7),
                                 c(FG1$t0[1],FG2$t0[1],FG3$t0[1],FG4$t0[1],FG5$t0[1],FG6$t0[1],Overall$t0[1]),
...
#create a effect size data frame = base for forest plot
effect_hist_SSP585 <- data.frame(c("India"),
                                 c("End. Herbivores","End. Carnivores","End. Omnivores",
                                   "Ect. Herbivores","Ect. Carnivores","Ect. Omnivores","Overall Biomass"),
                                 c(1,2,3,4,5,6,7),
                                 c(FG1$t0[1],FG2$t0[1],FG3$t0[1],FG4$t0[1],FG5$t0[1],FG6$t0[1],Overall$t0[1]),
...
#create a effect size data frame = base for forest plot
effect_hist_SSP126 <- data.frame(c("Vaupés, Colombia"),
                                 c("End. Herbivores","End. Carnivores","End. Omnivores",
                                   "Ect. Herbivores","Ect. Carnivores","Ect. Omnivores","Overall Biomass"),
                                 c(1,2,3,4,5,6,7),
                                 c(FG1$t0[1],FG2$t0[1],FG3$t0[1],FG4$t0[1],FG5$t0[1],FG6$t0[1],Overall$t0[1]),
...
#create a effect size data frame = base for forest plot
effect_hist_SSP585 <- data.frame(c("Vaupés, Colombia"),
                                 c("End. Herbivores","End. Carnivores","End. Omnivores",
                                   "Ect. Herbivores","Ect. Carnivores","Ect. Omnivores","Overall Biomass"),
                                 c(1,2,3,4,5,6,7),
                                 c(FG1$t0[1],FG2$t0[1],FG3$t0[1],FG4$t0[1],FG5$t0[1],FG6$t0[1],Overall$t0[1]),
...
#create a effect size data frame = base for forest plot
effect_hist_SSP126 <- data.frame(c("Kavango, Namibia"),
                                 c("End. Herbivores","End. Carnivores","End. Omnivores",
                                   "Ect. Herbivores","Ect. Carnivores","Ect. Omnivores","Overall Biomass"),
                                 c(1,2,3,4,5,6,7),
                                 c(FG1$t0[1],FG2$t0[1],FG3$t0[1],FG4$t0[1],FG5$t0[1],FG6$t0[1],Overall$t0[1]),
...
#create a effect size data frame = base for forest plot
effect_hist_SSP585 <- data.frame(c("Kavango, Namibia"),
                                 c("End. Herbivores","End. Carnivores","End. Omnivores",
                                   "Ect. Herbivores","Ect. Carnivores","Ect. Omnivores","Overall Biomass"),
                                 c(1,2,3,4,5,6,7),
                                 c(FG1$t0[1],FG2$t0[1],FG3$t0[1],FG4$t0[1],FG5$t0[1],FG6$t0[1],Overall$t0[1]),
...
#create a effect size data frame = base for forest plot
effect_hist_SSP126 <- data.frame(c("Central France"),
                                 c("End. Herbivores","End. Carnivores","End. Omnivores",
                                   "Ect. Herbivores","Ect. Carnivores","Ect. Omnivores","Overall Biomass"),
                                 c(1,2,3,4,5,6,7),
                                 c(FG1$t0[1],FG2$t0[1],FG3$t0[1],FG4$t0[1],FG5$t0[1],FG6$t0[1],Overall$t0[1]),
...
#create a effect size data frame = base for forest plot
effect_hist_SSP585 <- data.frame(c("Central France"),
                                 c("End. Herbivores","End. Carnivores","End. Omnivores",
                                   "Ect. Herbivores","Ect. Carnivores","Ect. Omnivores","Overall Biomass"),
                                 c(1,2,3,4,5,6,7),
                                 c(FG1$t0[1],FG2$t0[1],FG3$t0[1],FG4$t0[1],FG5$t0[1],FG6$t0[1],Overall$t0[1]),
...
#create a effect size data frame = base for forest plot
effect_hist_SSP126 <- data.frame(c("Centra Finland"),
                                 c("End. Herbivores","End. Carnivores","End. Omnivores",
                                   "Ect. Herbivores","Ect. Carnivores","Ect. Omnivores","Overall Biomass"),
                                 c(1,2,3,4,5,6,7),
                                 c(FG1$t0[1],FG2$t0[1],FG3$t0[1],FG4$t0[1],FG5$t0[1],FG6$t0[1],Overall$t0[1]),
...
#create a effect size data frame = base for forest plot
effect_hist_SSP585 <- data.frame(c("Centra Finland"),
                                 c("End. Herbivores","End. Carnivores","End. Omnivores",
                                   "Ect. Herbivores","Ect. Carnivores","Ect. Omnivores","Overall Biomass"),
                                 c(1,2,3,4,5,6,7),
                                 c(FG1$t0[1],FG2$t0[1],FG3$t0[1],FG4$t0[1],FG5$t0[1],FG6$t0[1],Overall$t0[1]),
...
Finland <- ggplot() +
  ...
  scale_x_continuous(breaks = seq(-100,100,5),limits=c(-15,5))+
  scale_shape_manual(values = c("circle","diamond"),guide="none")+
  labs(title="Centra Finland", x='Effect Size (% Change)', y = "Functional Group (FG)",col="Climate Scenario",trans="reverse")+
  geom_vline(xintercept=0, color='black', linetype='dashed') +
  theme_classic()+
  theme(axis.text.y = element_text(face = c('bold','plain', 'plain', 'plain', 'plain', 'plain', 'plain'),size=12,hjust=0))+
  theme(axis.text.x = element_text(size=12))+
...
#export df as csv 
write.csv(climate,regionpath %+% "climate_effect.csv")
...
annotate_figure(a, top = text_grob("Effect of Climate on a Natural Undisturbed Ecosystem State", 
                                   face = "bold", size = 14),
...
ggsave(regionpath %+% "change_Climate.pdf",width=297,height=210,units="mm")

###-----------------------------------------------------------------###
###      CREATE OVERALL BIOMASS FORESTPLOT OVERVIEW FOR REGIONS     ###
###-----------------------------------------------------------------###
#SSP126
regions_hist_SSP126 <- climate %>%
  subset(`Functional Group`=="Overall Biomass"& Scenario == "Historical/SSP1-2.6") 

names(regions_hist_SSP126) = c("Region","Scenario","FG", "Eff_size","lower","upper")

#SSP585
regions_hist_SSP585 <- climate %>%
  subset(`Functional Group`=="Overall Biomass"& Scenario == "Historical/SSP5-8.5") 

names(regions_hist_SSP585) = c("Region","Scenario","FG", "Eff_size","lower","upper")

#now plot the forest plot 
Regions_Climate <- ggplot() +
  geom_point(data=regions_hist_SSP126,aes(x=Eff_size,y=Region,col="Historical/SSP1-2.6"),size=3)+
  geom_errorbar(data=regions_hist_SSP126,aes(xmin=lower,xmax=upper,y=Region,col="Historical/SSP1-2.6"),width=0.1,size=0.3)+
  geom_point(data=regions_hist_SSP585,aes(x=Eff_size,y=Region,col="Historical/SSP5-8.5"),size=3)+
  geom_errorbar(data=regions_hist_SSP585,aes(xmin=lower,xmax=upper,y=Region,col="Historical/SSP5-8.5"),width=0.1,size=0.3)+
  scale_color_brewer(palette = "Set1",direction=-1)+
  scale_size_continuous(guide="none")+
  scale_x_continuous(breaks = seq(-100,100,2),limits=c(-8,2))+
  scale_shape_manual(values = c("circle","diamond"),guide="none")+
  labs(title="Climate", x='Effect Size (% Change)', y = "Regions",col="Climate Scenario",trans="reverse")+
  geom_vline(xintercept=0, color='black', linetype='dashed') +
  theme_classic()+
  theme(axis.text.x = element_text(size=12))+
...
save.image(outpath %+% "Forestplot_Climate_Image.Rdata")
